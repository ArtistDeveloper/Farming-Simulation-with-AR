...
public class CropCountSave : MonoBehaviour
{
    ...
    public void LoadCropCountData(){
        ...
        if(PlayerPrefs.HasKey("Watermelon_Count")){         //여긴 그냥 하면 됨. 그 이유는 불러와서 넣는 것일 뿐이기 떄문임. 저장하는게 문제인듯.
            ...
            watermelon_Text.text = "Watermelon: " + watermelon.ToString("0");
        }else{
            watermelon_Text.text = "Watermelon: 0";
        ...
        if(PlayerPrefs.HasKey("Carrot_Count")){
            ...
            Carrot_Text.text = "Carrot: " + Carrot.ToString("0");
        }else{
            Carrot_Text.text = "Carrot: 0";
        ...
        if(PlayerPrefs.HasKey("Potato_Count")){
            ...
            Potato_Text.text = "Potato: " + Potato.ToString("0");
        }else{
            Potato_Text.text = "Potato: 0";
        ...
        if(PlayerPrefs.HasKey("Asparagus_Count")){
            ...
            Asparagus_Text.text = "Asparagus: " + Asparagus.ToString("0");
        }else{
            Asparagus_Text.text = "Asparagus: 0";
        ...
        if(PlayerPrefs.HasKey("Beet_Count")){
            ...
            Beet_Text.text = "Beet: " + Beet.ToString("0");
        }else{
            Beet_Text.text = "Beet: 0";
        ...
        if(PlayerPrefs.HasKey("Pumkin_Count")){
            ...
            Pumkin_Text.text = "Pumkin: " + Pumkin.ToString("0");
        }else{
            Pumkin_Text.text = "Pumkin: 0";
        ...
        if(PlayerPrefs.HasKey("Onion_Count")){
            ...
            Onion_Text.text = "Onion: " + Onion.ToString("0");
        }else{
            Onion_Text.text = "Onion: 0";
        ...
        if(PlayerPrefs.HasKey("Lettuce_Count")){
            ...
            Lettuce_Text.text = "Lettuce: " + Lettuce.ToString("0");
        }else{
            Lettuce_Text.text = "Lettuce: 0";
        ...
        if(PlayerPrefs.HasKey("Wheat_Count")){
            ...
            Wheat_Text.text = "Wheat: " + Wheat.ToString("0");
        }else{
            Wheat_Text.text = "Wheat: 0";
        ...
        if(PlayerPrefs.HasKey("Broccoli_Count")){
            ...
            Broccoli_Text.text = "Broccoli: " + Broccoli.ToString("0");
        }else{
            Broccoli_Text.text = "Broccoli: 0";
